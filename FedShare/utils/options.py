...
def args_parser():
    ...
    #lstm argments
    parser.add_argument('--input_dim', type = int, default=3, help="Input dimension of signal data")
    parser.add_argument('--hidden_dim', type=int, default=128, help="Hidden unit for LSTM")
    parser.add_argument('--num_layers', type=int, default=2, help="number of layers in LSTM")
    parser.add_argument('--sq_len', type=int, default=100, help="Sequence Length")
    parser.add_argument('--overlap', type=float, default=0.4, help='Overlaping over sequence length')
