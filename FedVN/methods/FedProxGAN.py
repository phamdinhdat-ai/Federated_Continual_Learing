...
def train_FedProxGAN(data_obj, act_prob, learning_rate, batch_size, epoch,
    ...
    return train_FedGAN_common(data_obj=data_obj, act_prob=act_prob, learning_rate=learning_rate,
                            ...
                            model_func=model_func, init_model=init_model, init_g_model=init_g_model, sch_step=sch_step, sch_gamma=sch_gamma,
