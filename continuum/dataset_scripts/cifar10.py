...
class BreathDataset(DatasetBase):
    ...
    def download_load(self):
        self.train_data = np.load(file="./datasets/dynamic/dynamic_train_set.npy")[:, 1:5]
        self.test_data = np.load(file="./datasets/dynamic/dynamic_test_set.npy")[:, 1:5]
        self.val_data = np.load(file="./datasets/dynamic/dynamic_val_set.npy")[:, 1:5]
        self.train_label = self.train_data[:, -1]
        self.test_label = self.test_data[:, -1]
        self.val_label  = self.val_data[:, -1]
